...
#define IS_Motor(motor) (((motor) == Motor1) || ((motor) == Motor2))

typedef enum
{ Right,
	Left
}position;
#define IS_position(position) (((position) == Left) || ((position) == Right))
/******************************************************************************
                      ADC 
******************************************************************************/
...
void Motor_Rotate(Motor,position);
void Motor_Changespeed(Motor,uint16_t);
