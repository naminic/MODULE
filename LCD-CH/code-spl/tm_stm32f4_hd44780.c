...
#define HD44780_Delay(x)            delayMs(x);
...
//
#define TM_GPIO_SetPinValue(GPIOx, GPIO_Pin, val)	((val) ? GPIO_SetBits(GPIOx, GPIO_Pin) : GPIO_ResetBits(GPIOx, GPIO_Pin))
//
...
static void TM_HD44780_InitPins(void) {
	/* Init all pins */
//	GPIO_Ins2.GPIO_Mode= GPIO_Mode_Out_PP;
//	GPIO_Ins2.GPIO_Pin=  HD44780_RS_PIN | HD44780_E_PIN | HD44780_D4_PIN | HD44780_D5_PIN |  HD44780_D6_PIN  | HD44780_D7_PIN;
//	GPIO_Ins2.GPIO_Speed = GPIO_Speed_50MHz ;
//	//GPIO_Init(GPIOC,&GPIO_Ins2);
//	GPIO_Init(GPIOE,&GPIO_Ins2);
	//
